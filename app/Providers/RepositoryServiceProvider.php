...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public array $bindings = [
        ...
        ServiceContracts\Analyses\AnalizeTotalVByComponentsServiceInterface::class => Services\Analyses\AnalizeTotalVByComponentsService::class,
        ServiceContracts\Analyses\AnalizeTotalVServiceInterface::class => Services\Analyses\AnalizeTotalVService::class,
        ServiceContracts\Recipe\RecipeExportServiceInterface::class => Services\Recipe\RecipeExportService::class,
        ServiceContracts\Recipe\RecipeImportServiceInterface::class => Services\Recipe\RecipeImportService::class,
        ServiceContracts\Auth\AuthServiceInterface::class => Services\Auth\AuthService::class,
        ServiceContracts\Mqtt\MqttPublisherServiceInterface::class => Services\Mqtt\MqttPublisherService::class,
        ServiceContracts\Ttn\TtnUpdateServiceInterface::class => Services\Ttn\TtnUpdateService::class,
    ];
}
